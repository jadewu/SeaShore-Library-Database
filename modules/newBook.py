...
def newBook():
    if request.method == 'POST':
        ...
        cursor = conn.cursor()
        # insert information
        sql = "insert into books (book_name) values (%s)"
        val = (_bookname)
        ...
        _sc = 1
        # insert information
        sql = "insert into books_storage (instock, shelves_level, shelves_counting, book_id, shelf_id) values (%s,%s,%s,%s,%s)"
        val = (_instock, _shelflevel, _sc, book_id, _shelfid)
